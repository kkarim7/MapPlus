  ...
  L.Control.Rainviewer = L.Control.extend({
    ...
    onAdd: function (map) {
      ...
      this.container = L.DomUtil.create(
        "div",
        "leaflet-control-rainviewer leaflet-bar leaflet-control"
      );

      this.link = L.DomUtil.create(
        "a",
        "leaflet-control-rainviewer-button leaflet-bar-part",
        this.container
      );
      this.link.href = "#";
    ...
    load: function (map) {
      ...
      this.controlContainer = L.DomUtil.create(
        "div",
        "leaflet-control-rainviewer-container",
        this.container
      );

      this.prevButton = L.DomUtil.create(
        "input",
        "leaflet-control-rainviewer-prev leaflet-bar-part btn",
      ...
      this.startstopButton = L.DomUtil.create(
        "input",
      ...
      this.nextButton = L.DomUtil.create(
        "input",
        "leaflet-control-rainviewer-next leaflet-bar-part btn",
        this.controlContainer
      );
      ...
      this.positionSliderLabel = L.DomUtil.create(
        "label",
        "leaflet-control-rainviewer-label leaflet-bar-part",
        this.controlContainer
      );
      ...
      this.positionSlider = L.DomUtil.create(
        "input",
        "leaflet-control-rainviewer-positionslider leaflet-bar-part",
        this.controlContainer
      );
      ...
      this.opacitySliderLabel = L.DomUtil.create(
        "label",
        "leaflet-control-rainviewer-label leaflet-bar-part",
        this.controlContainer
      );
      ...
      this.opacitySlider = L.DomUtil.create(
        "input",
        "leaflet-control-rainviewer-opacityslider leaflet-bar-part",
        this.controlContainer
      );
      ...
      this.closeButton = L.DomUtil.create(
        "div",
      ...
      var html =
        '<div id="timestamp" class="leaflet-control-rainviewer-timestamp"></div>';
      ...
      if (!this.radarLayers[ts]) {
        this.radarLayers[ts] = new L.TileLayer(
            ...
            "/256/{z}/{x}/{y}/2/1_1.png",
          {
            ...
            transparent: true,
            attribution:
              '<a href="https://rainviewer.com" target="_blank">rainnviewer.com</a>',
            zIndex: ts,
          }
        );
      }
    ...
    setOpacity: function (e) {
      ...
      if (this.radarLayers[this.currentTimestamp]) {
        this.radarLayers[this.currentTimestamp].setOpacity(
          e.srcElement.value / 100
        );
      }
    },
